...
# static inline unsigned int ImCountSetBits(unsigned int v)   { unsigned int count = 0; while (v > 0) { v = v & (v - 1); count++; } return count; }    /* original C++ signature */
...
class MetricsConfig:
    ...
    # ImGuiMetricsConfig(bool ShowDebugLog = false, bool ShowIDStackTool = false, bool ShowWindowsRects = false, bool ShowWindowsBeginOrder = false, bool ShowTablesRects = false, bool ShowDrawCmdMesh = true, bool ShowDrawCmdBoundingBoxes = true, bool ShowTextEncodingViewer = false, bool ShowDockingNodes = false, int ShowWindowsRectsType = -1, int ShowTablesRectsType = -1, int HighlightMonitorIdx = -1, ImGuiID HighlightViewportID = 0);    /* original C++ signature */
    def __init__(
        self,
        show_debug_log: bool = False,
        show_id_stack_tool: bool = False,
...
class Window:
    ...
    def rect(self) -> ImRect:
        """(private API)"""
        pass
    # float       CalcFontSize() const    { ImGuiContext& g = *Ctx; return g.FontBaseSize * FontWindowScale * FontDpiScale * FontWindowScaleParents; }    /* original C++ signature */
...
# IMGUI_API void      ImFontAtlasUpdateSourcesPointers(ImFontAtlas* atlas);    /* original C++ signature */
def im_font_atlas_update_sources_pointers(atlas: ImFontAtlas) -> None:
    pass
